...
# Bot information
API_ID = environ.get('API_ID', '11611160')  #api id of your telegram id
if len(API_ID) == 0:
...
# Bot Admins
ADMINS = environ.get('ADMINS', '6717382350  1154420519') #apni tg id daalo
if len(ADMINS) == 0:
...
# Channels
INDEX_CHANNELS = [int(index_channels) if index_channels.startswith("-") else index_channels for index_channels in environ.get('INDEX_CHANNELS', '-1002366645874').split()]
if len(INDEX_CHANNELS) == 0:
    print('Info - INDEX_CHANNELS is empty')
AUTH_CHANNEL = [int(auth_channels) for auth_channels in environ.get('AUTH_CHANNEL', '-1002284070615').split()]
if len(AUTH_CHANNEL) == 0:
    print('Info - AUTH_CHANNEL is empty')
LOG_CHANNEL = environ.get('LOG_CHANNEL', '-1002264871308') #bot log channel -1005293546253
...
# support group
SUPPORT_GROUP = environ.get('SUPPORT_GROUP', '-1002174979742') #support group id ex:  -1002936246860
...
# Links
SUPPORT_LINK = environ.get('SUPPORT_LINK', 'https://t.me/FLimyWorLd_17')
UPDATES_LINK = environ.get('UPDATES_LINK', 'https://t.me/FLimyWorLd_17')
FILMS_LINK = environ.get('FILMS_LINK', 'https://t.me/FLimyWorLd_17')
TUTORIAL = environ.get("TUTORIAL", "https://t.me/FLimyWorLd_17")
VERIFY_TUTORIAL = environ.get("VERIFY_TUTORIAL", "https://t.me/FLimyWorLd_17")
